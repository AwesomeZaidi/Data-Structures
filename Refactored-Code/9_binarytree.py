...
queue = __import__('7_queue', fromlist=['LinkedQueue'])
...
class BinaryTreeNode(object):
    ...
    def height(self):
        ...
        Best Case: O(1) -> current node is a leaf so no traversing is required.
        Worst case: O(n) -> starting from the root node and traverse entire tree."""
        if self.is_leaf():
            return 0
