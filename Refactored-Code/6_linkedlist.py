...
class LinkedList(object):
    ...
    def get_at_index(self, index):
        ...
        # My Psuedocode:
            ...
            #   count up till you reach the index
            #   return that Node
    ...
    def insert_at_index(self, index, item):
        ...
        # My Psuedo Code
            # node = self.head
                ...
                # node.next = node
                # node = item
                # we found the index where we want to insert the item but there is a node there already.
                # set the node = item
                #set node.next = node itself
    ...
    def replace(self, old_item, new_item):
        ...
        if curr is None:
            raise ValueError('Old item out of range')
        ...
        raise ValueError('Old item out of rangee')
