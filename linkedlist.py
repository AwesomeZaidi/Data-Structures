...
class LinkedList(object):
    ...
    def get_at_index(self, index):
        ...
        # we have to start at the head of the LL
        # loop through till we get to our index and return that node data
    ...
    def insert_at_index(self, index, item):
        ...
        raise ValueError if the given index is out of range of the list size.
        Best case running time: O(1), index is 0
    ...
    def replace(self, old_item, new_item):
        ...
        Worst case running time: O(n), old_item index is self.size-1"""
